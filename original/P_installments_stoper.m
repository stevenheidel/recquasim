function [P, psi] = P_installments_stoper(H_i, H_f, T, tol, ninstal)

% self-evaluating and self-stopping version of P_installments
...
% run recurrence
for k = 1:ninstal
    psi_in = Taylor_installment_stoper(A, B, psi_in, step, tol);
    A = A + step*B;
end
psi = psi_in;
P = norm(psi(ind))^2;
